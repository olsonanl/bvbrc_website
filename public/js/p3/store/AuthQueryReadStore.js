define([
  ...
  return declare([QueryReadStore], {
    ...
    _fetchItems: function (request, fetchHandler, errorHandler) {
      ...
      {
        serverQuery.type = this.type;
      }
      if (this.workspaces && this.workspaces.length > 0)
      {
        serverQuery.workspaces = this.workspaces;
      }
      // Booleans encode as strings. Coerce to numeric.
      serverQuery.writableWorkspaces = this.writableWorkspaces ? 1 : 0;
    ...
    _setTypeAttr: function (type) {
      console.log('Set store type to ' + type);
      this.type = type;
    }
  });
});
